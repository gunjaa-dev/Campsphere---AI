                    ...
                    {isEditing ? (
                        <>
                            ...
                            <button
                                ...
                                className="flex items-center gap-2 px-4 py-2 border border-gray-300 dark:border-gray-700 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-900 transition"
                            >
                                <X size={18} />
                                Cancel
                            </button>
